...
import org.SpecikMan.Controller.PracticeSection.ItemController;
        ...
        try {
            ...
            if (listLevel.size() != 0) {
                ...
                for (int i = 0; i < nodes.length; i++) {
                    ...
                    loader.setLocation(DashboardController.class.getResource("/fxml/SatisticsFXMLs/MyLevel_item.fxml"));
                    nodes[i] = loader.load();
