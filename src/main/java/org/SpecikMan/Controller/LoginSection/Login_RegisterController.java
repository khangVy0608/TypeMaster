...
public class Login_RegisterController implements Initializable {
    ...
    public void open_signup() {
        ...
        t.setOnFinished(e -> {
            try {
                fxml = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/fxml/LoginFXMLs/SignUp.fxml")));
    ...
    public void open_signin() {
        ...
        t.setOnFinished(e -> {
            try {
                fxml = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/fxml/LoginFXMLs/SignIn.fxml")));
                movedVbox.getChildren().removeAll();
                movedVbox.getChildren().setAll(fxml);
            } catch (IOException ex) {
                ex.printStackTrace();
