        ...
        try {
            ...
            for (int i = 0; i < data.length(); i++) {
                ...
                details.add(new AccountLevelDetails(
                        ...
                        obj.getString("accountLevel") == "null" ? null : Integer.valueOf(obj.getString("accountLevel")),
                        obj.getString("levelCap") == "null" ? null : Integer.valueOf(obj.getString("levelCap")),
