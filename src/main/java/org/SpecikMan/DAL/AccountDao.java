...
public class AccountDao implements Dao<Account> {
            ...
            if (rs.isBeforeFirst()) {
                while (rs.next()) {
                    accounts.add(new Account(rs.getString("idAccount"), rs.getString("username"),
                            ...
                            rs.getDate("dob"),rs.getString("verificationCode"),rs.getString("uud"),rs.getString("idRole"), rs.getString("nameRole")));
                }
            }
    ...
    public void add(Account account) {
        try {
            ...
            prepareStatement.setString(6,account.getVerificationCode());
            prepareStatement.setString(7,account.getUud());
